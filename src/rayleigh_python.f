...
c  30  continue
c      if(r(n).lt.6.e6.or.rho(n).lt.500.0.or.vpv(n).lt.100.0) then
c      if(r(n).lt.1.e6.or.rho(n).lt.500.0.or.vpv(n).lt.100.0) then
c	write(6,*) 'WARNING!!!! Is your input in MKS units???'
...
c	   vsh(i) = vsh(i)*tau
c32      continue	  
c        write(6,*) 'corrected for WARNING as follows:'
c	write(6,*) 'r,rho,vpv,vsv,vph,vsh multiplied by 1000 to'
c	write(6,*) 'convert to MKS units.'
