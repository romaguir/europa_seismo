...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.snr_value = QtGui.QDoubleSpinBox(self.centralwidget)
        self.snr_value.setMaximum(1.0)
        self.snr_value.setSingleStep(0.05)
        self.snr_value.setObjectName(_fromUtf8("snr_value"))
        self.horizontalLayout_2.addWidget(self.snr_value)
        self.line = QtGui.QFrame(self.centralwidget)
        self.line.setFrameShape(QtGui.QFrame.VLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.horizontalLayout_2.addWidget(self.line)
        self.motion_type = QtGui.QComboBox(self.centralwidget)
        self.motion_type.setObjectName(_fromUtf8("motion_type"))
        self.motion_type.addItem(_fromUtf8(""))
        self.motion_type.addItem(_fromUtf8(""))
        self.motion_type.addItem(_fromUtf8(""))
        self.horizontalLayout_2.addWidget(self.motion_type)
        ...
        self.corners = QtGui.QSpinBox(self.centralwidget)
        self.corners.setMinimum(2)
        self.corners.setMaximum(16)
        self.corners.setProperty("value", 4)
        ...
        self.gridLayout_4.addWidget(self.label_21, 1, 8, 1, 1)
        self.gamma = QtGui.QDoubleSpinBox(self.centralwidget)
        self.gamma.setMaximum(1.0)
        self.gamma.setProperty("value", 0.5)
        self.gamma.setObjectName(_fromUtf8("gamma"))
        self.gridLayout_4.addWidget(self.gamma, 1, 9, 1, 1)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1178, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.motion_type.setItemText(0, _translate("MainWindow", "displacement", None))
        self.motion_type.setItemText(1, _translate("MainWindow", "velocity", None))
        self.motion_type.setItemText(2, _translate("MainWindow", "acceleration", None))
        ...
        self.planet.setItemText(0, _translate("MainWindow", "Europa", None))
        self.planet.setItemText(1, _translate("MainWindow", "Mars", None))
        self.planet.setItemText(2, _translate("MainWindow", "Earth", None))
        ...
        self.mft_type.setItemText(0, _translate("MainWindow", "butterworth", None))
        self.mft_type.setItemText(1, _translate("MainWindow", "gaussian", None))
        self.mft_type.setItemText(2, _translate("MainWindow", "bessel", None))
        self.label_21.setText(_translate("MainWindow", "gamma", None))
