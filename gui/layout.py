...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.save_dispersion_curve = QtGui.QPushButton(self.centralwidget)
        self.save_dispersion_curve.setObjectName(_fromUtf8("save_dispersion_curve"))
        self.gridLayout_4.addWidget(self.save_dispersion_curve, 1, 8, 1, 1)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1110, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.save_dispersion_curve.setText(_translate("MainWindow", "save curve", None))
